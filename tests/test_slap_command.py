...
class TestSlapCommand:
    ...
    def test_slap_creates_pending_default(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_slap_with_set_creates_active_default_and_offer(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_slap_error_when_default_exists(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_slap_error_no_extension_specified(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_slap_verbose_output(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_slap_multiple_extensions_uses_first(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_slap_pending_to_active_transition(self, runner, mock_executable, isolated_data_dir, monkeypatch):
