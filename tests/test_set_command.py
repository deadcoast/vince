...
class TestSetCommand:
    ...
    def test_set_creates_active_default(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_set_error_when_default_exists(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_set_error_no_extension_specified(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_set_verbose_output(self, runner, mock_executable, isolated_data_dir, monkeypatch):
    ...
    def test_set_pending_to_active_transition(self, runner, mock_executable, isolated_data_dir, monkeypatch):
