...
class TestRejectCommand:
    ...
    def test_reject_transitions_offer_to_rejected(
    ...
    def test_reject_with_complete_delete_flag(
        self, runner, isolated_data_dir, monkeypatch
    ):
    ...
    def test_reject_verbose_output(self, runner, isolated_data_dir, monkeypatch):
        ...
        assert (
            "Rejecting offer" in result.output
            or "State changed" in result.output
            or "Found offer" in result.output
        )
