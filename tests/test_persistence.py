...
from vince.persistence.defaults import DefaultsStore, DEFAULT_SCHEMA
...
from vince.persistence.offers import OffersStore, DEFAULT_SCHEMA as OFFERS_DEFAULT_SCHEMA
