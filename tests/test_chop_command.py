...
class TestChopCommand:
    ...
    def test_chop_with_forget_removes_active_default(self, runner, isolated_data_dir, monkeypatch):
    ...
    def test_chop_error_when_no_default_exists(self, runner, isolated_data_dir, monkeypatch):
    ...
    def test_chop_without_forget_shows_info(self, runner, isolated_data_dir, monkeypatch):
    ...
    def test_chop_error_no_extension_specified(self, runner, isolated_data_dir, monkeypatch):
    ...
    def test_chop_pending_default_to_removed(self, runner, isolated_data_dir, monkeypatch):
