...
class TestForgetCommand:
    ...
    def test_forget_removes_active_default(self, runner, isolated_data_dir, monkeypatch):
    ...
    def test_forget_error_when_no_default_exists(self, runner, isolated_data_dir, monkeypatch):
    ...
    def test_forget_pending_default_to_removed(self, runner, isolated_data_dir, monkeypatch):
    ...
    def test_forget_error_no_extension_specified(self, runner, isolated_data_dir, monkeypatch):
