...
class TestErrorClassCompleteness:
    ...
    *For any* VinceError subclass, it SHALL have code, message, and recovery 
    ...
    def test_all_error_classes_have_required_attributes(self, error_class):
        ...
        assert hasattr(error, "code"), f"{error_class.__name__} missing 'code' attribute"
        assert hasattr(error, "message"), f"{error_class.__name__} missing 'message' attribute"
        assert hasattr(error, "recovery"), f"{error_class.__name__} missing 'recovery' attribute"
    ...
    def test_error_codes_in_correct_category(self, error_class):
        ...
        assert category in ERROR_CODE_RANGES, \
            f"Unknown category {category} for {error_class.__name__}"
        assert error.code in ERROR_CODE_RANGES[category], \
    ...
    def test_error_str_includes_code_and_message(self, error_class):
        ...
        assert "test_value" in error.message or len(error.message) > 0, \
    ...
    def test_errors_are_vince_error_subclasses(self, error_class):
        ...
        assert issubclass(error_class, VinceError), \
...
class TestErrorCodeCoverage:
    ...
    def test_all_input_errors_implemented(self):
        ...
        assert expected == implemented, f"Missing input errors: {expected - implemented}"
    ...
    def test_all_state_errors_implemented(self):
        ...
        assert expected == implemented, f"Missing state errors: {expected - implemented}"
    ...
    def test_all_config_errors_implemented(self):
        ...
        assert expected == implemented, f"Missing config errors: {expected - implemented}"
    ...
    def test_all_system_errors_implemented(self):
        ...
        assert expected == implemented, f"Missing system errors: {expected - implemented}"
